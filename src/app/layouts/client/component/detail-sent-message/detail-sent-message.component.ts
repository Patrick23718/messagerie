...
@Component({
  selector: 'app-detail-sent-message',
  templateUrl: './detail-sent-message.component.html',
  styleUrls: ['./detail-sent-message.component.scss'],
})
export class DetailSentMessageComponent implements OnInit, OnChanges {
  @Input() message = '';
